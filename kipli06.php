...
echo color("white","                  Format Kode 62*** \n");
	...
	$post = [
         ...
         echo color("white","-] WES TAU DAFTAR DES");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
